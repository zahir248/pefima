...
@endif
                ...
                <form action="{{ url('updateexpensefunc',$expense->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" value="{{ $expense->name }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" placeholder="Enter name">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="amount" name="amount" value="{{ $expense->amount }}" required step="0.01" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" placeholder="Enter amount">
                    </div>

                    <div class="mb-4">
                        <label for="date" class="block text-gray-700">Date</label>
                        <input type="date" id="date" name="date" value="{{ $expense->date }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
