...
<x-app-layout>
    ...
    <input type="number" id="amount" name="amount" required step="0.01" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" placeholder="Enter amount">
</div>
                    ...
                    <!-- Import excel Button -->
            <a href="{{ route('importexcel') }}" class="btn btn-success bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600" style="margin-left: 10px">
                    Import Excel File
                </a>
