            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4"> <!-- Use col-md-3 for a sidebar width of 1/4 -->
                    <div class="bg-white p-4 rounded-lg shadow-md text-center">
                        <div class="mb-3">
                            <a href="{{ route('budget') }}"
                                class="d-block bg-primary text-white p-3 rounded-lg shadow-lg hover:bg-red-700 transition duration-300 ease-in-out mb-3"
                                style="text-decoration:none">
                                Budget Tracking
                            </a>
                            <a href="{{ route('goal') }}"
                                class="d-block bg-success text-white p-3 rounded-lg shadow-lg hover:bg-blue-700 transition duration-300 ease-in-out mb-3"
                                style="text-decoration:none">
                                Savings Goal
                            </a>
                            <a href="{{ route('debt') }}"
                                class="d-block bg-danger text-white p-3 rounded-lg shadow-lg hover:bg-yellow-700 transition duration-300 ease-in-out mb-3"
                                style="text-decoration:none">
                                Debt Tracking
                            </a>
                        </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4">
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-4"> <!-- Responsive column for cards -->
                                <div
                                    class="bg-white text-black p-4 rounded-lg shadow-lg d-flex flex-column h-100 justify-content-center align-items-center">
