...
<head>
    ...
    <style>
        ...
        .feature-card {
            ...
            /* Vertical center */
            padding: 10px;
            /* Reduce padding for a smaller appearance */
            color: white;
        ...
        .debt-management {
            background-image: url('/images/debt.jpg');
            /* Change this to your image URL */
        }

        .financial-reports {
            background-image: url('/images/report.jpeg');
            /* Change this to your image URL */
        }
        ...
        .feature-container {
            max-width: 100%;
            /* Set the overall width of the grid to 100% */
            margin: 0;
            /* Remove margin */
            padding: 0;
            /* Remove padding */
        ...
        .content {
            flex: 1;
            /* This will allow the content area to grow and take available space */
            padding-bottom: 100px;
            /* Add bottom padding for space above the footer */
        }
...
<div class="header">
    <div class="container d-flex justify-content-end">
        @if (Route::has('login'))
            @auth
                <a href="{{ url('/home') }}" class="btn btn-primary" style="color: black;">Home</a>
            @else
                <!-- Login and Register buttons -->
                <a href="{{ route('login') }}" style="color: black;">Login</a>

                @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="ml-5" style="color: black;">Register</a>
                @endif
            @endauth
        @endif
    </div>
