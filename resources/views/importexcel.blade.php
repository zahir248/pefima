    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ url('uploadexcel') }}" method="POST" enctype="multipart/form-data" id="excelUploadForm">
                    @csrf

                    <!-- File input for uploading Excel file -->
                    <div class="mb-4">
                        <label for="file" class="block text-gray-700">Upload Excel File</label>
                        <input type="file" id="file" name="file" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" accept=".xls,.xlsx" required>
                    </div>

                    <div class="flex space-x-4">
                        <button type="submit" class="btn btn-success bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">
                            Upload
                        </button>
                    </div>
                </form>
