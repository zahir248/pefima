    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <!-- Navigation Buttons -->
                <a href="{{ route('expensesinput') }}" class="btn btn-success mb-4" style="margin-right: 5px" >Input Expenses</a>
                ...
                <form method="GET" action="{{ route('budget') }}" class="mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" value="{{ request('name') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" placeholder="Search by name">
                        </div>
                        <!-- Filter by Category -->
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="date" name="date" value="{{ request('date') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        </div>

                    </div>

                    <button type="submit" class="btn btn-secondary bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">
                        Apply Filters
                    </button>
                </form>
                        ...
                        <tbody class="text-center">
                            @forelse($expenses as $expense)
                                <tr>
                                    ...
                                    <td>{{ $expense->date }}</td>
                                    <td>
    <a href="{{ url('updateexpense', $expense->id) }}" class="btn btn-primary" style="margin-right: 5px">Edit</a>
