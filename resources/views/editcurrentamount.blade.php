...
<div class="mb-4">
    ...
    <input type="number" id="current_amount" name="current_amount" value="0.00" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ $goal->current_amount }}" required step="0.01">
</div>        
